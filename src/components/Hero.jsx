            ...
            <section className="text-gray-600 body-font max-w-7xl m-auto px-4">
                <div className="container mx-auto flex px-5 py-20 md:flex-row flex-col items-center lg:h-screen">
                    <div className="lg:flex-grow md:w-1/2 lg:pr-16 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">A place to put your
                            <br className="hidden lg:inline-block"/><b className="text-yellow-500"> Pillow</b>
                        </h1>
                        <p className="mb-8 leading-relaxed">Real estate ranging from affordable to supreme luxury.</p>
                        <div className="flex justify-center">
                            <button className="inline-flex text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded text-lg"><Link to="/properties">Explore Properties</Link></button> 
                        </div>
                    </div>
